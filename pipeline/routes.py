...
ROUTES: list[dict] = [
    ...
    {"id": "SR-89", "name": "Truckee ↔ Monitor Pass", "road_no": "89", "seasonal": True,
     "note": "Links Truckee & Tahoe to Monitor Pass (~8,310 ft) & Markleeville",
     "towns": [("Truckee", 39.3280, -120.1833), ("Tahoe City", 39.1658, -120.1428), ("Markleeville", 38.6952, -119.7782), ("Monitor Pass", 38.6730, -119.6190)]},
